...
public class character4 extends Actor
{
    ...
    private GreenfootImage right = new GreenfootImage("character4.png");
    private GreenfootImage left = new GreenfootImage("character4.2.png");
    ...
    public void shoot() {
        if(Greenfoot.mouseClicked(getWorld())) {
            Actor fireball = new fireball2();
            getWorld().addObject(fireball,getX(), getY());
            
            MouseInfo mouse = Greenfoot.getMouseInfo();
            fireball.turnTowards(mouse.getX(), mouse.getY());
        }
    }
}
